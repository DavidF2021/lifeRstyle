...
#'
#' Fits linear regression, ANOVA, and mixed models to data.
#' @param obj An object.
#' @param data_type The type of data to be modelled.
#' @param fit_type The type of model required, either linear regression (\code{"lm"}),
#' ANOVA (\code{"anova"}), or mixed models (\code{"mixed"}).
...
#' Fit basic statistical models
#'
#' Fits linear regression, ANOVA, and mixed models to data from the CSO.
#' @param obj An object of class \code{"lifeRstyle"} generated by \code{\link{Load_LifeRstyle}}.
#' @param data_type The type of data to be modelled.
#' @param fit_type The type of model required, either linear regression (\code{"lm"}),
#' ANOVA (\code{"anova"}), or mixed models (\code{"mixed"}).
#' @param ... Catches unused arguments
#'
#' @returns An object of class \code{"Fit_LifeRStyle"} which inculdes the model details
#' as well as the data set and \code{fit_type}
#' @export
#'
#' @examples
